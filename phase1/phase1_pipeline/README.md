...
Pipeline preprocessing modular (`.py`) untuk Phase 1 proyek Data Mining. Desain: preprocessing dibangun sebagai skrip Python yang reproducible, sedangkan EDA & justifikasi keputusan didokumentasikan di notebook (`data-mining-phase1.ipynb`).
